...
public:
	...
	void createShaderLayer(const Ratio& ratio, unsigned int previewHeight, const std::string& fragmentShaderFilepath, LayerID registryID = 0);
	void createEffectLayer(const Ratio& ratio, unsigned int previewHeight, const std::string& fragmentShaderFilepath, LayerID targetLayerID, LayerID registryID = 0);
